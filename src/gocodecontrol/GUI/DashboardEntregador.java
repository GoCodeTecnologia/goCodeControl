...
public class DashboardEntregador extends javax.swing.JFrame {

    private Usuario usuario;
    
    public DashboardEntregador() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashboardEntregador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DashboardEntregador().setVisible(true);
            }
        });
    }

...
public class FrmCadTalhao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label2.setText("Cadastrar talhão");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCadTalhao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmCadTalhao().setVisible(true);
            }
        });
    }
